...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("Events/" + event_post_id + "/Comments")
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!comment_message.isEmpty()) {
                    ...
                    firebaseFirestore.collection("Events/" + event_post_id + "/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override
